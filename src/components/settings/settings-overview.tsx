...
export function SettingsOverview({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const [membersRes, invitesRes, templatesTotal, templatesPending, tagsRes, fieldsRes, customersRes] =
  ...
  }, [user?.id, accountId, activeProjectId, canManageMembers, canManageCustomers]);
      ...
      ? [
          {
            ...
            subtitle:
              counts?.customers == null
                ? t('viewCustomers')
                : t('customersCount', { count: counts.customers }),
          },
        ]
      : []),
  ];
