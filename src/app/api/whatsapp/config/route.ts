...
export async function GET() {
  try {
    ...
    // Both QR and Cloud API are always available. If no whatsapp_config
    // exists, the standard "no_config" response is returned below.
...
export async function POST(request: Request) {
  try {
    ...
    // MaSa CRM is single-tenant-per-WhatsApp-number — letting two accounts
