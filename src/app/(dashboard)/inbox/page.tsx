...
const CONTACT_PANEL_STORAGE_KEY = "masacrm:inbox:contact-panel-open";
...
function InboxPageInner() {
  ...
  return (
    <div className="-m-4 flex h-[calc(100vh-3.5rem)] flex-col overflow-hidden sm:-m-6">
      {/* WhatsApp sync status — in the flex column, not absolute, so it
          pushes the panels down instead of overlapping them. Live: it
          tracks the active project's session row, so a number that
          drops off shows here rather than looking like a quiet day. */}
      <ChannelStatusBanner projectId={activeProjectId} />
