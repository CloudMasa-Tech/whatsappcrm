...
```bash
# 1. Fork on GitHub: https://github.com/ArnasDon/masacrm → Fork
# 2. Clone your fork
git clone https://github.com/<your-username>/masacrm.git
cd masacrm
...
```bash
git remote add upstream https://github.com/ArnasDon/masacrm.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/ArnasDon/masacrm/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `masacrm.tech` URL belong to the upstream project; please swap them
