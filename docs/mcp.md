...
MaSa CRM ships a [Model Context Protocol](https://modelcontextprotocol.io)
...
[`MaSa CRM-mcp`](https://www.npmjs.com/package/MaSa CRM-mcp). Under the hood
     ...
     "mcpServers": {
       "MaSa CRM": {
         ...
         "env": {
           ...
           "WACRM_API_KEY": "masacrm_live_xxxxxxxxxxxxxxxxxxxxxxxx"
         }
       }
     }
   }
